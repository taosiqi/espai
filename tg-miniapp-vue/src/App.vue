...
import { EXTERNAL_URL, INTERNAL_URL, SAMPLE_BASE64, TG_SHARE_TEXT } from './constants'
import { getTelegramLaunchParams, isTelegramMiniAppLaunch, loadTelegramSdk } from './telegram'
